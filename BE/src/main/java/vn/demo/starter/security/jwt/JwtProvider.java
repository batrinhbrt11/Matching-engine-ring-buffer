...
public class JwtProvider {
    ...
    public GenerateJwtResult generateToken(Map<String, Object> extraClaims, User user) {
        ...
        String accessToken = Jwts.builder()
                ...
                .setId(accessTokenId)
                .claim("userId", user.getId())
                .claim("firstName", Objects.nonNull(user.getUserDetail()) ? user.getUserDetail().getFirstName() : AppConstants.EMPTY_STR)
                .claim("lastName", Objects.nonNull(user.getUserDetail()) ? user.getUserDetail().getLastName() : AppConstants.EMPTY_STR)
                .setSubject(user.getEmail())
